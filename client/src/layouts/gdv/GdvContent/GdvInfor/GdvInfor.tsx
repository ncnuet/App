      ...
      <div className="flex flex-col p-4 bg-white rounded-[15px] shadow-sd2 gap-[10px]">
        <div className="w-full flex flex-row items-center">
          <div className="flex flex-col flex-1">
            ...
            <h2 className="text-base text-cblue-600 font-bold">EB126513VN</h2>
          </div>
          <button className="outline-none h-[34px] px-[10px] rounded-[8px] flex flex-row items-center bg-cyellow-500 hover:opacity-80 hover:cursor-pointer">
